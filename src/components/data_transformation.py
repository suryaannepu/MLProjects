...
class DataTransformationConfig:
    preprocessor_obj_file_path = os.path.join('artifacts', "preprocessor.pkl")  # fixed typo: proprocessor → preprocessor
...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        try:
            ...
            categorical_columns = [
                "gender",
                "race/ethnicity",  # FIXED: column name must match dataset exactly
            ...
            cat_pipeline = Pipeline(
                steps=[
                    ...
                    ("one_hot_encoder", OneHotEncoder(handle_unknown="ignore")),  # Added safety for unknown categories
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            # Defensive check
            expected_columns = numerical_columns + [
                "gender",
                "race/ethnicity",
                "parental level of education",
                "lunch",
